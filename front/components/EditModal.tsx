...
const Modal = () => {
  ...
  return (
    <>
      <button
        onClick={toggleModal}
        className="bg-transparent hover:bg-green-500 text-green-700 font-semibold hover:text-white border border-green-500 hover:border-transparent py-2 px-4 rounded-r"
      >
        updateeee
      </button>
      {open ? (
